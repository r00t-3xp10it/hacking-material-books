...
<blockquote>WARNING:<br />Before you can run a resource script,<br />you need to identify the required parameters that need to be configured for the script to run</blockquote>
