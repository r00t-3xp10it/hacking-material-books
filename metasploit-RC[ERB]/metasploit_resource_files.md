...
<blockquote>The next resource script uses db_nmap metasploit core command to populate msfdb database with hosts (address), then the ruby function will check what hosts (address) as been capture and run 3 post-exploitation modules againts all hosts stored in msfdb.</blockquote>
