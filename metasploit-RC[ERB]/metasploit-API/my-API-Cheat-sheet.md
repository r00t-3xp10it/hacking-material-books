...
<blockquote>This initialize method is basically boilerplate code that tells metasploit information about your module<br />so it can display said information to users inside the metasploit console.</blockquote>
