...
<blockquote>The purpose of this cheat sheet is to describe some common scripting technics for some of the various components of the Metasploit Framework to assiste developers into writing metasploit modules, it is worthy to note that the Metasploit has a full-featured Ruby client API. [Documentation for rapid7/metasploit-framework](https://www.rubydoc.info/github/rapid7/metasploit-framework/index)</blockquote>
