...
If we wish to run all module options at once, then simple edit the module before port it to metasploit,<br />
and add the above lines on it, save it and use it. the above line will config that options to run auto at module execution. 
