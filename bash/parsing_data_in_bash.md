...
<br />
      ...
      to chose our 'delimiter' char and print the field we want. In the next example we will extract
      the 2º field of our mac address using awk -F switch with (:) as delimiter char.
